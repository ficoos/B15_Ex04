...
namespace Ex04.Menus.Interfaces
{
	public class MainMenu : IMenu
	{
		...
		public IMenu AddMenu(string i_Title)
		{
			...
			IMenu menu = new MainMenu(i_Title, r_Depth + 1, v_IsSubMenu);
			r_ItemList.Add(menu);
			return menu;
		}

		public void AddItem(string i_Title, IMenuItemAction i_Action)
		{
			r_ItemList.Add(new MenuAction(i_Title, i_Action));
		}
